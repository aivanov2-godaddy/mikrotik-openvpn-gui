...
If private advisories are unavailable, contact the repository owner through an already established private channel. Do not create a public disclosure channel for this private project.

There is no public bug-bounty program or guaranteed response SLA. The maintainer will assess impact before any production change.
