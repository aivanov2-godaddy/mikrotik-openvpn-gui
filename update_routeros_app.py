...
This project now ships as an immutable linux/arm64 image from private GHCR. The
legacy updater modified a host-mounted /app directory and restarted production in
place, bypassing CI, image identity, canary isolation, and reliable rollback.
